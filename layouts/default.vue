<template>
  <div>
    <nav class="p-6 border-b border-gray-300">
      ...
      <button @click="signOut" class="h-10 px-5 m-2 text-blue-100 transition-colors duration-150 bg-blue-600 rounded-lg focus:shadow-outline hover:bg-blue-700">Sign Out</button>
    </nav>
